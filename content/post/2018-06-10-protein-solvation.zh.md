+++ 
title = "蛋白质溶解过程的计算机模拟"
description = "蛋白质溶解过程是一个非常有意思但也很有挑战的过程。  本文展示了利用粗粒化模型模拟蛋白质溶解到水中的研究。" 
date = "2018-06-10T10:50:00"
categories = ["molart"]
tags = ["CG"]
...
生物分子的溶解能的计算是一个长期困扰计算生物学家的问题。 至今仍然没有一个令人满意的解决方案。 
我在此文中展示了第一个用粗粒化蛋白质和显式水模型研究蛋白质溶解过程的模拟工作。 
我们的结果揭示了一些惊人的现象， 例如蛋白质表面周围的气泡形成过程。  
