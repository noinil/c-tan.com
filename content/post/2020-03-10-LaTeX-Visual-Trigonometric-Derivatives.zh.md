+++ 
title = "无字证明尝试： 基本三角函数与它们的微分"
description = "最近忙到吐血， 于是用 TikZ 来放松一下自己， 弄了一张集所有三角函数和它们的导数于一体的小图片。"
date = "2020-03-10T22:00:00"
categories = ["technique"]
tags = ["LaTeX"]

slug = "latex-visual-trig-derivatives"
summary = "这是一次无字证明的尝试： 将所有基础三角函数与其微分的推导过程都放到同一张小图片里面。  当然， 是用 LaTeX 绘制。"
+++ 

既然是无字证明， 我就尽量不做任何有意义的必要说明。

![Visual trigonometric derivatives](/img/posts/screenshots/scrot_latex_visual_trig_derivatives_2020-03-10.png)

无须多言， 请尽情下载 [PDF 版本](/download/visual_trig_derivatives_2020-03-10.pdf).

打破惯例， 这次我决定放出代码 (主要使用 [TikZ](https://texwiki.texjp.org/?TikZ) )。
然而相信如此霸气无理的代码风格， 根本没有人能够看得懂。
